...
<div class="kmfdcpr-admin-container kmfdcpr-settings">
    ...
    <div class="post-types-container">
        <!-- placeholder post type for using on add-row -->
        <div class="single-post-type placeholder" style="display: none">
            <h2>Book</h2>
        ...
        <?php foreach($post_types as $post_type): ?>
            <div class="single-post-type">
                <h2><?php echo esc_html($post_type["title"]); ?></h2>
                <div class="fields-container">
    ...
    <div class="kmfdcpr-field action-field">
        <button type="button" class="button button-primary add-row">Add New Post Type</button>
        <button type="submit" class="button button-primary save">Save</button>
    </div>
